...
To do so, locate the Maestro config file (config/obscuria/maestro-client.toml) and make sure the config reads vanilla_enabled = false
...
https://soundcloud.com/solas_composer

Licensed under Creative Commons BY-SA Attribution 4.0 International
...
https://blayne-norrick.itch.io

https://soundcloud.com/blayne-norrick
